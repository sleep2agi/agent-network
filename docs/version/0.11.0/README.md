...
| 5 | **canonical preview 收敛**（两条并行 preview 线合一，单点发布 `.34`/`.26`） | release ops | **PR #454 head 23586495**：完整终态 + test386 fixtures 补齐（首轮门禁 5/7 PASS、6/7 根因已修）；原执行节点撞 codex usage limit，门禁重跑已接力转派 | 7 套门禁全绿 → Windows 复验 → 单点发布 |
