> Archived: anet.sh changelog entries for v0.9.2 (2026-05-16) and earlier, plus the roadmap of that time, moved here on 2026-09-25 (docs slimming). Content kept as-is; links starting with `/` refer to pages on anet.sh.

# Changelog archive (v0.9.2 and earlier)
