# @sleep2agi/agent-node 2.5.0-preview.37 — release notes

本版与 `@sleep2agi/agent-network@2.3.0-preview.51` **配对发布**（两个包的版本必须成对，
`agent-network` 会精确校验）。节点侧改动见 #1276；hub 侧的 #1277/#1279 需要重启 hub 才生效。
