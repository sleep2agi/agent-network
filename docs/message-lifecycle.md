...
| # | 改动 | 状态 | 落地位置 |
|---|------|------|------|
| 1 | CommHub server 加 `send_reply` / `send_ack` 工具 | ✅ shipped | [server/src/tools.ts:2159 send_reply](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2159) + [tools.ts:2173 send_ack](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2173) |
