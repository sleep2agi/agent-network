...
| # | 改动 | 状态 | 落地位置 |
|---|------|------|------|
| 1 | CommHub server 加 `send_reply` / `send_ack` 工具 | ✅ shipped | [server/src/tools.ts:2183 send_reply](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2183) + [tools.ts:2197 send_ack](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2197) |
