...
| # | 改动 | 状态 | 落地位置 |
|---|------|------|------|
| 1 | CommHub server 加 `send_reply` / `send_ack` 工具 | ✅ shipped | [server/src/tools.ts:2169 send_reply](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2169) + [tools.ts:2183 send_ack](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2183) |
...
| 3 | 低价值消息过滤 | agent-node | ✅ v1.4.0；截至 [`04f37800` 的 cli.ts:4725 `shouldSkipMessage`](https://github.com/sleep2agi/agent-network/blob/04f37800/agent-node/src/cli.ts#L4725) |
