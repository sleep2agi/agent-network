...
| # | 改动 | 状态 | 落地位置 |
|---|------|------|------|
| 1 | CommHub server 加 `send_reply` / `send_ack` 工具 | ✅ shipped | [server/src/tools.ts:2176 send_reply](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2176) + [tools.ts:2190 send_ack](https://github.com/sleep2agi/agent-network/blob/main/server/src/tools.ts#L2190) |
