// RFC-030 Wave 1B L3-R5 — gateway lifecycle: eager boot + reconnect with
...
export interface GatewayLifecycleOptions<S extends LifecycleSessionLike> {
...
export class GatewayLifecycle<S extends LifecycleSessionLike> {
  private readonly opts: GatewayLifecycleOptions<S>;
  ...
  constructor(opts: GatewayLifecycleOptions<S>) {
    this.opts = opts;
