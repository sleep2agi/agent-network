...
import { GatewayLifecycle, type LifecycleSessionLike } from "./lifecycle";
...
describe("GatewayLifecycle — eager boot", () => {
...
describe("GatewayLifecycle — reconnect with capped exponential backoff", () => {
