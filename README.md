...
| 包 | 版本 | 角色 |
|---|---|---|
| [`@sleep2agi/agent-network`](https://www.npmjs.com/package/@sleep2agi/agent-network) | `2.1.14` | `anet` CLI —— Hub / Dashboard / Agent / Demo 启动器 |
...
| [`@sleep2agi/agent-node`](https://www.npmjs.com/package/@sleep2agi/agent-node) | `2.3.9` | Agent 运行时 —— Claude Code CLI / Claude Agent SDK / Codex SDK |
...
> [!IMPORTANT]
> **当前 stable: v0.9.1**（Apache 2.0，2026-05-15 通过 npm `latest` tag 发布 —— [#130 hotfix](https://github.com/sleep2agi/agent-network/issues/130) intern tool calling 修复，详见 [changelog](https://anet.sh/changelog#v0-9-1-patch-130-intern-tool-calling-hotfix-promote-2026-05-15-stable)；项目 [2026-05-11 开源](https://github.com/sleep2agi/agent-network/releases)）。作者每天自用、持续打磨，欢迎试用 + 提意见。次要版本之间 API 仍可能变动，请固定依赖版本。
>
