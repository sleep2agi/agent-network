...
Full walkthrough: [docs-site/docs/guide/getting-started.md](docs-site/docs/guide/getting-started.md) (live at https://anet.sh/guide/getting-started).

## Packages

| Package | Version | Role |
|---|---|---|
| [`@sleep2agi/agent-network`](https://www.npmjs.com/package/@sleep2agi/agent-network) | 2.0.3-preview.4 | `anet` CLI — hub / dashboard launchers, node management |
| [`@sleep2agi/commhub-server`](https://www.npmjs.com/package/@sleep2agi/commhub-server) | 0.5.3-preview.0 | MCP + REST + SSE hub, SQLite-backed |
| [`@sleep2agi/agent-network-dashboard`](https://www.npmjs.com/package/@sleep2agi/agent-network-dashboard) | 0.2.1-preview.1 | Web UI: Chat / Nodes / Tasks / Messages / Networks / Logs / Admin |
| [`@sleep2agi/agent-node`](https://www.npmjs.com/package/@sleep2agi/agent-node) | 2.2.0-preview.1 | Agent runtime — `claude-agent-sdk` (verified), `codex-sdk`, `claude-code-cli`, `http-api` |
...
docs-site/       VitePress docs (https://anet.sh)
...
These commands or paths exist in the codebase but are explicitly **not** part of the primary supported flow:

- `anet quickstart` — legacy guided setup; use the explicit `anet hub start` + `anet node create` steps above for predictable runs.
...
- Cloud-hosted hub at `agent-net.vansin.me` — local / LAN is the supported deployment today.

## Docs

- [docs-site](docs-site/) — VitePress source for https://anet.sh
