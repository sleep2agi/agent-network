...

{
  ...
  printf '%s\n' \
    ...
    GROK_CLAUDE_RULES_ENABLED GROK_CURSOR_RULES_ENABLED \
    GROK_CLAUDE_AGENTS_ENABLED GROK_CURSOR_AGENTS_ENABLED \
    GROK_CLAUDE_MCPS_ENABLED GROK_CURSOR_MCPS_ENABLED \
    GROK_CLAUDE_HOOKS_ENABLED GROK_CURSOR_HOOKS_ENABLED \
    GROK_CLAUDE_SESSIONS_ENABLED GROK_CURSOR_SESSIONS_ENABLED \
