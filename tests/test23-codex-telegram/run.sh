...
RECV_STATUS=$(mcp_call "${NTOK}" "report_status" "{\"resume_id\":\"worker-session-1\",\"alias\":\"worker-agent\",\"agent\":\"agent-node:codex\",\"status\":\"idle\",\"node_id\":\"node-worker-001\",\"node_name\":\"worker-agent\",\"session_id\":\"sess-worker-1\",\"channels\":\"[]\",\"model\":\"gpt-5.4-mini\",\"network_id\":\"${NET_ID}\"}")
