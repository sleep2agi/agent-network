...
const expectedTools = [
  ...
  "read_node_rules_file", "write_node_rules_file", "list_node_skills", "read_node_skill", "list_node_files", "read_node_file", "get_rules_file_request", "ack_rules_file_request", "get_rules_file_result",
  "restart_node",
