...
cp agent-network/src/im/feishu/bridge.ts /tmp/test661-bridge.orig
...
cp /tmp/test661-bridge.orig agent-network/src/im/feishu/bridge.ts
...
cp agent-node/src/runtime/feishu-outbound-dir.ts /tmp/test661-outbound.orig
...
cp /tmp/test661-outbound.orig agent-node/src/runtime/feishu-outbound-dir.ts
