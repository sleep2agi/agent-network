...
check_grep '2 天和 9 天' "$ZH" "Chinese guide records production duplicate evidence"
check_grep 'two and nine days' "$EN" "English guide records production duplicate evidence"
