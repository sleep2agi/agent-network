...
> **Phase 1 + Phase 2 all latest LIVE (2026-05-16) + v0.10.1 hotfix (2026-05-17) + v0.10.2 Hero A disk + Hero D ship (2026-05-17)**: 4 packages on npm `latest` — `@sleep2agi/agent-network@2.2.1` / `@sleep2agi/agent-node@2.4.1` (v0.10.2 Hero A adds host disk telemetry via `df -k`) / `@sleep2agi/commhub-server@0.8.2` / `@sleep2agi/agent-network-dashboard@0.5.1` (v0.10.2 Hero D topology prefix-label Option C + disk render + 100+ rounds of polish R317-R438). Full changes in [changelog](/en/changelog).

::: tip ✅ v0.10.2 stable — all 4 packages shipped (covers v0.10.0 Phase 1+2 + v0.10.1 hotfix + v0.10.2 Hero A+D)
...
| `@sleep2agi/agent-network-dashboard` | `0.5.1` ✅ (v0.10.2 Hero D + disk render + 100+ rounds of polish) |
