...
> **Phase 1 + Phase 2 all latest LIVE (2026-05-16) + v0.10.1 hotfix (2026-05-17)**: 4 packages on npm `latest` — `@sleep2agi/agent-network@2.2.1` (v0.10.1 hotfix: PINNED bump fixes a [`anet hub start` default-path functionality regression](/en/changelog#v0-10-1-—-hotfix-pinned-server-version-chain-bump-after-the-v0-10-0-ship-2026-05-17-✅-stable)) / `@sleep2agi/agent-node@2.4.0` / `@sleep2agi/commhub-server@0.8.2` / `@sleep2agi/agent-network-dashboard@0.5.0`. Full changes in [changelog v0.10.0](/en/changelog#v0-10-0-direct-runtime-observability-foundations-2026-05-16-stable-phase-1-3-package-promote).
