...
| `codex-app-server` *(preview)* | start / adopt a codex app-server bridge ([RFC-030](https://github.com/sleep2agi/agent-network/blob/main/docs/rfcs/RFC-030-codex-tui-bridge.md)) | Human-agent co-presence: a human and the agent share one codex session | OpenAI Codex (default gpt-5.6-sol) |
