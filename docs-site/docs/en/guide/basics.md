...
After logging in, run `anet whoami`. You should see output like (verified at [`cli.ts:3281-3302 whoamiCommand`](https://github.com/sleep2agi/agent-network/blob/main/agent-network/bin/cli.ts#L3281)):
```
