...
<!-- version-claim: package=agent-network channel=preview version=2.3.0-preview.117 -->
...
Today's `latest` (`2.3.0-preview.76`) and `preview` (`2.3.0-preview.117`) both print a random password: `anet-` followed by 22 hex characters.
