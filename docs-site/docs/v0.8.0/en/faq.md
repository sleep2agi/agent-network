...
::: warning v0.8.0-era answer: not recommended
The code has a `DATABASE_URL=postgres://...` entry point, but PostgreSQL **has not been end-to-end verified on the v0.8.0 stable line** — don't use it in production yet.
