...
> **Phase 1 + Phase 2 全部 latest LIVE（2026-05-16）+ v0.10.1 hotfix（2026-05-17）**：4 包通过 npm `latest` tag ship —— `@sleep2agi/agent-network@2.2.1`（v0.10.1 hotfix PINNED bump 修 [`anet hub start` 默认路径 functionality regression](/changelog#v0-10-1-hotfix-pinned-server-version-跟-v0-10-0-ship-chain-bump-2026-05-17-stable)）/ `@sleep2agi/agent-node@2.4.0` / `@sleep2agi/commhub-server@0.8.2` / `@sleep2agi/agent-network-dashboard@0.5.0`。完整变更见 [changelog v0.10.0](/changelog#v0-10-0-direct-runtime-observability-foundations-2026-05-16-stable-phase-1-3-包-promote)。

::: tip ✅ v0.10.0 stable 全 4 包 ship 完
