...
本页是当前 stable（v0.9.2）端到端跑通的最小路径。每一步都经过 Playwright + Docker E2E 验证，照着敲就能走通。

::: tip 组件职责（v0.9.2 stable）
...
::: info 已验证（当前 v0.9.2 stable，继承 v2 E2E 覆盖 + v0.8 新增回归 + v0.9.2 #129/#132/#136 修复链）
