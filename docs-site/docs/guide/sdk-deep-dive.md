...
- **gpt-5.5 当前是 default**（v0.10.3 [#149](https://github.com/sleep2agi/agent-network/issues/149) 起从 gpt-5.4 升级）：cli.ts 多处 hardcode。MiniMax 等第三方 codex provider 接入计划已记入 RFC 但还没落。
