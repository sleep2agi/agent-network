...
| `anet demo sci-team [opts]` | **科研军团**：1 leader + N-1 worker（默认 10，5-50 可调）；**Phase 1 scaffold** — leader 当前为 placeholder echo，真正的智能 fan-out 排在 [RFC-008](https://github.com/sleep2agi/agent-network/blob/main/docs/rfcs/RFC-008-sci-team-fanout.md) Phase 2 |
